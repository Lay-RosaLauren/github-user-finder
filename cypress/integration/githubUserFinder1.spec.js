describe('GitHub User Finder', () => {
  context('No errors', () => {
    ...
    it('searches for a specific repo', () => {
      cy.intercept(
        'GET',
        'https://api.github.com/repos/Lay-RosaLauren/AgilizeiSpark',
        { body: repos[0] }
      ).as('getRepo')
    ...
    it('searches for an unnexistent repo', () => {
      cy.intercept(
        'GET',
        'https://api.github.com/repos/Lay-RosaLauren/repo-1000',
        { body: [] }
      ).as('getNoRepoFound')
    ...
    it('shows starred repos', () => {
      ...
      cy.intercept(
        'GET',
        'https://api.github.com/users/Lay-RosaLauren/starred?page=1&per_page=4',
